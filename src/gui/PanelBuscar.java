 ...
 * que se busca es por nombre del solicitante o por título. Si los dos checkbox
 * están marcados, el trámite específico que se busca debe coincidir en ambos
 * campos, si ninguno de los checkbox están marcados se realiza una búsqueda
 * general de trámites específicos. En los campos de texto se puede ingresar el
 * nombre del solicitante o título que se busca.
 * </p>
...
public class PanelBuscar extends JPanel implements ActionListener {
    ...
    /**
     * Campo de texto donde se ingresa el nombre del solicitante que se va a
     * buscar en los trámites.
     */
    private JTextField nombre;
    /**
     * Campo de texto donde se ingresa el título que se va a buscar en los
     * trámites.
     */
    private JTextField titulo;
    /**
     * Botón que sirve para empezar la búsqueda dentro de la lista de trámites.
     */
    ...
    /**
     * Guarda todos los trámites específicos que se encuentran en la búsqueda.
     *
     ...
     *
     * @param listaTramites Todos los trámites específicos que hay en el trámite
     * actual.
     */
     ...
     * correspondientes para realizar la búsqueda. Se manda a llamar el método
     * buscar.
     * </p>
     *
     ...
     *
     * @param buscarNombre Palabra con la que se va a buscar el nombre del
     * solicitante.
     * @param buscarTitulo Palabra con la que se va a buscar el título.
     * @see #valoresTramite(TramiteEspecifico)
     */
     ...
     *
     * @param t Trámite especifico del cual se van a obtener sus valores.
    ...
    /**
     * Elimina de la tabla la fila con el valor del parámetro que recibe el
     * método.
     *
