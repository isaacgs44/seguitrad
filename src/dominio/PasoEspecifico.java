...
public class PasoEspecifico implements Comparable<PasoEspecifico> {
    ...
    /**
     * Función que devuelve el nombre de un paso seleccionado de un JList desde
     * la vista DialogoSeguimiento.
     *
     * @param posicion El parámetro posición define el índice del paso que se ha
     * seleccionado
     * @param pasosEspecificos El parámetro pasosEspecificos recibe una lista de
     * pasos del trámite seleccionado
     * @return El nombre del paso sin realizar seleccionado en la vista
     * DialogoSeguimiento
     */
